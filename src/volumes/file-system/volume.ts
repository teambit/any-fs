...
export class Volume implements AnyFS {
  ...
  access(
    ...
    // @ts-ignore
    fs.access(this.getPath(path), mode, callback);
  }

  accessSync(path: PathLike, mode?: number): void {
    fs.accessSync(this.getPath(path), mode);
  }
  ...
  appendFile(
    ...
    // @ts-ignore
    fs.appendFile(this.getPath(file), data, options);
  }
  ...
  appendFileSync(
    ...
    fs.appendFileSync(this.getPath(file), data, options);
  }
  ...
  chmod(
    ...
    fs.chmod(this.getPath(path), mode, callback);
  }

  chmodSync(path: PathLike, mode: string | number): void {
    fs.chmodSync(this.getPath(path), mode);
  }
  ...
  chown(
    ...
    fs.chown(this.getPath(path), uid, gid, callback);
  }

  chownSync(path: PathLike, uid: number, gid: number): void {
    fs.chownSync(this.getPath(path), uid, gid);
  }
  ...
  createReadStream(
    ...
    return fs.createReadStream(this.getPath(path), options);
  }
  ...
  createWriteStream(
    ...
    return fs.createWriteStream(this.getPath(path), options);
  }

  exists(path: PathLike, callback: (exists: boolean) => void): void {
    fs.exists(this.getPath(path), callback);
  }
  ...
  lchmod(
    ...
    fs.lchmod(this.getPath(path), mode, callback);
  }

  lchmodSync(path: PathLike, mode: string | number): void {
    fs.lchmodSync(this.getPath(path), mode);
  }
  ...
  lchown(
    ...
    fs.lchown(this.getPath(path), uid, gid, callback);
  }

  lchownSync(path: PathLike, uid: number, gid: number): void {
    fs.lchownSync(this.getPath(path), uid, gid);
  }
  ...
  lstat(
    ...
    fs.lstat(this.getPath(path), callback);
  }
  ...
  mkdir(
    ...
    // @ts-ignore
    fs.mkdir(this.getPath(path), options, callback);
  }
  ...
  mkdirSync(
    ...
    fs.mkdirSync(this.getPath(path), options);
  }
  ...
  open(
    ...
    // @ts-ignore
    fs.open(this.getPath(path), flags, mode, callback);
  }
  ...
  openSync(
    ...
    return fs.openSync(this.getPath(path), flags, mode);
  }
  ...
  readdir(
    ...
    // @ts-ignore
    fs.readdir(this.getPath(path), options, callback);
  }
  ...
  readdirSync(
    ...
    // @ts-ignore
    return fs.readdirSync(this.getPath(path), options);
  }
  ...
  readlink(
    ...
    // @ts-ignore
    fs.readlink(this.getPath(path), options, callback);
  }
  ...
  readlinkSync(
    ...
    return fs.readlinkSync(this.getPath(path), options);
  }
  ...
  realpath(
    ...
    //@ts-ignore
    fs.realpath(this.getPath(path), options, callback);
  }
  ...
  realpathSync(
    ...
    return fs.realpathSync(this.getPath(path), options);
  }
  ...
  rmdir(
    ...
    fs.rmdir(this.getPath(path), callback);
  }
  ...
  stat(
    ...
    fs.stat(this.getPath(path), callback);
  }
  ...
  symlink(
    ...
    //@ts-ignore
    fs.symlink(target, this.getPath(path), type, callback);
  }
  ...
  symlinkSync(
    ...
    fs.symlinkSync(target, this.getPath(path), type);
  }
  ...
  truncate(
    ...
    //@ts-ignore
    fs.truncate(this.getPath(path), len, callback);
  }

  truncateSync(path: PathLike, len?: number | null): void {
    fs.truncateSync(this.getPath(path), len);
  }
  ...
  unlink(
    ...
    fs.unlink(this.getPath(path), callback);
  }
  ...
  utimes(
    ...
    fs.utimes(this.getPath(path), atime, mtime, callback);
  }
  ...
  utimesSync(
    ...
    fs.utimesSync(this.getPath(path), atime, mtime);
  }
  ...
  writeFile(
    ...
    // @ts-ignore
    fs.writeFile(this.getPath(path), data, options);
  }
  ...
  writeFileSync(
    ...
    fs.writeFileSync(this.getPath(path), data, options);
  }
